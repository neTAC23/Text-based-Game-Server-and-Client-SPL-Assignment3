...
public class GameRooms {
	...
	private Map<ProtocolCallback<StringMessage>, String> _callbacksToNicks;
	private Map<String, ProtocolCallback<StringMessage>> _nicksToCallbacks;
	...
	private GameRooms () {
		...
		_callbacksToNicks = new ConcurrentHashMap <ProtocolCallback<StringMessage>,String>();
		_nicksToCallbacks = new ConcurrentHashMap <String, ProtocolCallback<StringMessage>>();
	...
	public void insertNick (String nick, ProtocolCallback<StringMessage> callback) {
	...
	public boolean userExist (ProtocolCallback<StringMessage> callback) {
	...
	public void disconnectGamer (String gamerName, ProtocolCallback<StringMessage> callback) {
