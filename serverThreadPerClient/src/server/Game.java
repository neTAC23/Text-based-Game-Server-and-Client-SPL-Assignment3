...
public abstract class Game { //abstract class of a game
	...
	protected Map <String, ProtocolCallback<String>> _nickToCallback;
	...
	public Game (String gameName, String roomName, LinkedList<String> players, String fileName) {
		...
		_roomName=roomName;
		_players = players;
		_nickToCallback = new HashMap <String, ProtocolCallback<String>>();
	...
	public void addCallback(String nick, ProtocolCallback<String> callback) {
